...
import { orgs, users, locations, eventInstances, events, authAccounts, authSessions, attendance, attendanceXAttendanceTypes, attendanceTypes, eventInstancesXEventTypes, eventTypes, eventTags, eventTagsXEventInstances, eventTagsXEvents, eventsXEventTypes, expansions, expansionsXUsers, orgsXSlackSpaces, slackSpaces, positions, positionsXOrgsXUsers, permissions, rolesXPermissions, roles, rolesXUsersXOrg, updateRequests, slackUsers, achievements, achievementsXUsers } from "./schema";
...
export const attendanceXAttendanceTypesRelations = relations(attendanceXAttendanceTypes, ({one}) => ({
...
export const attendanceTypesRelations = relations(attendanceTypes, ({many}) => ({
	attendanceXAttendanceTypes: many(attendanceXAttendanceTypes),
}));

export const eventInstancesXEventTypesRelations = relations(eventInstancesXEventTypes, ({one}) => ({
	eventInstance: one(eventInstances, {
...
export const eventTagsXEventInstancesRelations = relations(eventTagsXEventInstances, ({one}) => ({
	eventInstance: one(eventInstances, {
...
export const eventTagsXEventsRelations = relations(eventTagsXEvents, ({one}) => ({
	event: one(events, {
...
export const eventsXEventTypesRelations = relations(eventsXEventTypes, ({one}) => ({
	event: one(events, {
...
export const expansionsXUsersRelations = relations(expansionsXUsers, ({one}) => ({
...
export const orgsXSlackSpacesRelations = relations(orgsXSlackSpaces, ({one}) => ({
	org: one(orgs, {
...
export const positionsXOrgsXUsersRelations = relations(positionsXOrgsXUsers, ({one}) => ({
	org: one(orgs, {
...
export const rolesXPermissionsRelations = relations(rolesXPermissions, ({one}) => ({
...
export const rolesXUsersXOrgRelations = relations(rolesXUsersXOrg, ({one}) => ({
	org: one(orgs, {
...
export const achievementsXUsersRelations = relations(achievementsXUsers, ({one}) => ({
